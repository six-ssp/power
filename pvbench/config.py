...
class ExperimentConfig:
    ...
    adaptive_patience: int = 6
    adaptive_learning_rate: float = 3e-4
    ...
    physical_violation_tolerance_ratio: float = 0.01
    physical_violation_min_margin: float = 0.01
    num_workers: int = 4
