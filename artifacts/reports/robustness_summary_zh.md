...
## 5. 当前判断
- 多随机种子下，`Hybrid` 的平均 MAE 为 `0.018796 +/- 0.001966`，低于 `TFT` 的 `0.021144 +/- 0.004029` 与 `StackedXGB` 的 `0.026599 +/- 0.005934`。
- rolling-origin 下，`Hybrid` 的平均 MAE 为 `0.027830 +/- 0.006528`，仍低于 `TFT` 的 `0.033845 +/- 0.008390` 与 `StackedXGB` 的 `0.034299 +/- 0.008551`。
